...
It starts by looking at index 0. That position corresponds to that day of fish creating a new fish each 
as well as resetting their own timer. In order to cause that, that value at position
...
Index resets every cycle,  due to the formula i % 9, to move back to the first item, and this process is 
repeated until the input amount of days have finished
"""